...
- DB enums: campaign_scope, ownership_transfer_behavior, campaign_trigger_type, campaign_rule_type, discount_type, campaign_network_type, reward_status, referrer_product_type, inventory_item_type, inventory_status, order_status, payment_status, customer_type
...
- Operations: tabbed layout at /operations with Inventory Management (bulk CSV import) and Order Dispatch
