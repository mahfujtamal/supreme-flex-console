...
export default function HubManagerPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['dashboard/hub-manager', page, search],
    queryFn: () =>
      nodeApi.get('/dashboard/hub-manager', { params: { page, per_page: 20, search } })
        .then(r => r.data),
  });

  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-bold">Hub Manager</h1>
      <input
